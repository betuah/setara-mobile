        ...
        <SafeAreaView>
            ...
            >
                ...
                <Appbar.Content
                    ...
                    subtitle={data.createdDate ? `Diterbitkan ${moment(data.createdDate).format('DD MMM YYYY')} ( ${moment(data.createdDate).startOf('day').fromNow()} )` : (data.subtitle ? data.subtitle : null)}
                    titleStyle={{
                        ...fonts.semiBold,
                        fontSize: 14,
                        ...titleStyle,
